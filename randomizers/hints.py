...
class HintsRandomizer(BaseRandomizer):
  ...
  def __init__(self, rando):
    ...
    self.hint_importance: bool
    
    self.hoho_hint_shards: bool
    self.korl_hints_swords: bool
    self.kreeb_hints_bows: bool
  ...
  def load_hint_text_files():
    ...
    with open(os.path.join(DATA_PATH, "hint_stone_tablets.txt"), "r") as f:
      HintsRandomizer.hint_stone_tablets = yaml.load(f)
