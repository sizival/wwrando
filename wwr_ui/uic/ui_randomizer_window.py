...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fairy_fountains_have_chests = QCheckBox(self.groupBox_qol_experimental)
        self.fairy_fountains_have_chests.setObjectName(u"fairy_fountains_have_chests")

        self.verticalLayout_qol_experimental.addWidget(self.fairy_fountains_have_chests)
        ...
        QWidget.setTabOrder(self.fix_auction, self.fairy_fountains_have_chests)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fairy_fountains_have_chests.setText(QCoreApplication.translate("MainWindow", u"Fairy Fountain Chests", None))
